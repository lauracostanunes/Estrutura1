...
// 3. Inserindo as pessoas na ordem correta
...
// 5 e 6. Atendendo a primeira pessoa
let atendido1 = filaAtendimento.dequeue();
console.log(`\nChamado: ${atendido1}\n`);

console.log("Fila após atendimento:");
console.log(filaAtendimento.print());

// 7. Chegada de novas pessoas
filaAtendimento.enqueue("Rafael");
filaAtendimento.enqueue("Isabela");
filaAtendimento.enqueue("Cauã");

// 8. Imprimindo a fila atualizada
console.log("\nFila após chegada de novas pessoas:");
console.log(filaAtendimento.print());

// 9. Próxima pessoa
let proximaPessoa = filaAtendimento.peek();
console.log(`\nPróximo a ser atendido: ${proximaPessoa}`);

// 10. Atendendo essa pessoa
let atendido2 = filaAtendimento.dequeue();
console.log(`\nChamado: ${atendido2}\n`);
